...
(function (BuildPieceType) {
    ...
    BuildPieceType[BuildPieceType["WALL"] = 1] = "WALL";
    BuildPieceType[BuildPieceType["SLOPE"] = 2] = "SLOPE";
 ...
 */
export function encodeBuildIntent(intent) {
 ...
 */
export function decodeBuildIntent(reader) {
    return {
        pieceType: reader.readUint8(),
 ...
 */
export function decodeBuildCommit(reader) {
    return {
 ...
 */
export function decodeBuildSync(reader) {
